    ...
    <div className="flex flex-col w-full font-body bg-[#FAF7F0]">
      ...
      <section className="w-full bg-[#FAF7F0]" id="philosophy-section">
        <div className="py-16 md:py-24 px-6 lg:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
          <div className="lg:col-span-6 rounded-3xl overflow-hidden shadow-xl h-80 md:h-[450px] bg-cover bg-center" style={{ backgroundImage: `url('https://lh3.googleusercontent.com/aida-public/AB6AXuCSW7hoE6xPY6K3W__6pOhqhwU7cglkjWTURSGqd5lIW-TEGEHg8UMwd8skMWYfipsQZhoKNC5tvdPLuduvmO5l4Im3g3Kx8yO7yn_wUPD4d8YvbJkvvcmNqcCKMOczCj5mTPQUWyH-wyYgXtrYc9lDfPFKR9H-_LmdY5hKwf0mciQi2AMQ2XVyBpcgOPGUflzUd3HF6XvKjNgSMQ8E8CJNc5TC5knu1VuZCvV3k4LVT_PoHeuAaKvD')` }}>
          </div>
        
        <div className="lg:col-span-6 flex flex-col justify-center">
          <span className="text-[#D4B47C] font-bold tracking-widest uppercase text-xs mb-2 block">Our Foundation</span>
          <h2 className="text-3xl md:text-4xl font-bold text-[#1d1b20] mb-6 font-headline leading-tight">Designed for Ownership. Managed for Peace of Mind.</h2>
          <div className="w-12 h-1 bg-[#D4B47C] mb-6 rounded-full" />
          <p className="text-sm md:text-base text-[#494551] leading-relaxed mb-4">
            Owning farmland should be about enjoying nature—not managing it. At Prashantha Vana, every aspect of the community is thoughtfully planned and professionally maintained, allowing you to experience the rewards of farmland ownership with complete peace of mind.
          </p>
      ...
      <section className="w-full bg-[#193A22] relative overflow-hidden border-y border-[#D4B47C]/20" id="investment-opportunity">
        {/* Decorative blur */}
      ...
      <section className="w-full bg-[#FAF7F0] py-16 md:py-24" id="lifestyle-experience">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="flex flex-col justify-center lg:pl-8">
            <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Experience</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#1d1b20] mb-12 font-headline leading-tight">More Than Farmland.<br/>A Place to Slow Down.</h2>
            ...
            <div className="flex flex-col mb-12">
              {[
                ...
                <div key={idx} className="flex items-center gap-4 py-4 border-b border-[#cbc4d2]/30 last:border-0">
                  <Check className="w-4 h-4 text-[#193A22] shrink-0" strokeWidth={3} />
                  <span className="text-sm md:text-base text-[#494551] font-medium">{item}</span>
                </div>
              ))}
            </div>
      ...
      {/* Amenities Section */}
      <section className="w-full bg-[#EEE3D3] py-16 md:py-24" id="amenities-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Amenities</span>
          <h2 className="text-3xl md:text-5xl font-bold text-[#1d1b20] mb-16 font-headline leading-tight">
            More Than Farmland.<br/>A Countryside Lifestyle.
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden group">
              <img src="/courtyard.jpg" alt="Courtyard House" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            ...
            <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden group">
              <img src="/pool.png" alt="Swimming Pool" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
              <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-1.5 rounded-full text-sm font-medium">
                Swimming Pool
              </div>
            ...
            <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden group">
              <img src="/play.png" alt="Children's Play Area" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
              <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-1.5 rounded-full text-sm font-medium">
            ...
            <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden group">
              <img src="/cafeteria.jpg" alt="Cafeteria" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
              <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-1.5 rounded-full text-sm font-medium">
                Cafeteria
              </div>
            ...
            <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden group">
              <img src="/cottages.png" alt="Cottages & Guest Rooms" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
              <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-1.5 rounded-full text-sm font-medium">
            ...
            <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden group">
              <img src="/landscaped.jpg" alt="Landscaped Common Areas" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors" />
              <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-1.5 rounded-full text-sm font-medium">
          ...
          <p className="text-xs md:text-sm text-[#494551]/70 max-w-5xl mx-auto font-medium">
            Also Included: Solar Street Lights · Grand Entrance Arch · Pre-Cast Compound Wall · Internal Roads · 24×7 Security · CCTV Surveillance · Fruit-Bearing Plantations · Outdoor Relaxation Areas
          </p>
        </div>
      </section>

      {/* Why Us Section */}
      <section className="w-full bg-[#FAF7F0] py-16 md:py-24" id="why-us-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Why Prashantha Vana</span>
          <h2 className="text-3xl md:text-5xl font-bold text-[#1d1b20] mb-16 font-headline leading-tight">
            Designed for Peace. Managed<br/>for Convenience.
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="bg-white rounded-2xl p-8 shadow-lg text-left border-t-4 border-[#D4B47C] flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <span className="text-2xl font-serif font-bold text-[#193A22] mb-4">I</span>
              <h3 className="text-sm font-bold text-[#1d1b20] mb-3">Individual Ownership</h3>
              <p className="text-xs md:text-sm text-[#494551] leading-relaxed">
                Own a clearly identified private farmland plot within a secure, planned community.
              </p>
            </div>
            
            <div className="bg-white rounded-2xl p-8 shadow-lg text-left border-t-4 border-[#D4B47C] flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <span className="text-2xl font-serif font-bold text-[#193A22] mb-4">II</span>
              <h3 className="text-sm font-bold text-[#1d1b20] mb-3">Professionally Managed</h3>
              <p className="text-xs md:text-sm text-[#494551] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg text-left border-t-4 border-[#D4B47C] flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <span className="text-2xl font-serif font-bold text-[#193A22] mb-4">III</span>
              <h3 className="text-sm font-bold text-[#1d1b20] mb-3">Connected Yet Peaceful</h3>
              <p className="text-xs md:text-sm text-[#494551] leading-relaxed">
                Experience peaceful countryside living with convenient main-road connectivity near Gauribidanur.
              </p>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-lg text-left border-t-4 border-[#D4B47C] flex flex-col hover:-translate-y-1 transition-transform duration-300">
              <span className="text-2xl font-serif font-bold text-[#193A22] mb-4">IV</span>
              <h3 className="text-sm font-bold text-[#1d1b20] mb-3">Lifestyle and Investment</h3>
              <p className="text-xs md:text-sm text-[#494551] leading-relaxed">
                Use your farmland as a weekend retreat, family escape or long-term land investment.
              </p>
            </div>
          </div>
      ...
      <section className="w-full bg-[#193A22] py-16 md:py-24" id="schedule-visit-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start">
          {/* Left Column: Text & Stats */}
          <div className="flex flex-col text-white">
            <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Take the next step</span>
            ...
            <p className="text-sm md:text-base text-white/80 leading-relaxed mb-10 max-w-lg font-light">
              Share your details and our farmland advisor will contact you shortly to plan your visit to Prashantha Vana.
            </p>
              ...
              {[
                ...
                <div key={idx} className="flex items-center gap-4">
                  <div className="w-5 h-5 rounded-full bg-[#D4B47C] flex items-center justify-center shrink-0">
                    <Check className="w-3.5 h-3.5 text-[#193A22]" strokeWidth={3} />
                  </div>
                  <span className="text-sm md:text-base text-white/90 font-medium">{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
              <div className="flex flex-col">
                <span className="text-3xl font-serif font-bold text-[#D4B47C]">10</span>
                <span className="text-[10px] uppercase tracking-wider text-white/60 mt-1">Acres</span>
              </div>
              <div className="flex flex-col">
                <span className="text-3xl font-serif font-bold text-[#D4B47C]">47</span>
                <span className="text-[10px] uppercase tracking-wider text-white/60 mt-1">Plots</span>
              </div>
              <div className="flex flex-col">
                <span className="text-3xl font-serif font-bold text-[#D4B47C]">₹58L</span>
                <span className="text-[10px] uppercase tracking-wider text-white/60 mt-1">Starting From</span>
              </div>
              <div className="flex flex-col">
                <span className="text-3xl font-serif font-bold text-[#D4B47C]">75 min</span>
                <span className="text-[10px] uppercase tracking-wider text-white/60 mt-1">From Bengaluru</span>
              </div>
            </div>

            <p className="text-xs text-white/50 leading-relaxed">
              Main-Road Connected &nbsp;|&nbsp; Individual Plot Ownership &nbsp;|&nbsp; Water & Electricity &nbsp;|&nbsp; 24×7 Security
            </p>
          </div>
          ...
          <div className="bg-[#FAF7F0] rounded-[2rem] p-8 md:p-10 shadow-2xl flex flex-col">
            <div className="grid grid-cols-1 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-[#193A22]">Full Name</label>
                <input type="text" placeholder="Enter your full name" className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm" />
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-[#193A22]">Mobile Number</label>
                  <input type="tel" placeholder="10-digit mobile number" className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-[#193A22]">Email Address</label>
                  <input type="email" placeholder="you@email.com" className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm" />
                </div>
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-[#193A22]">Current City</label>
                <input type="text" placeholder="e.g. Bengaluru" className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm" />
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-[#193A22]">Investment Budget</label>
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-[#193A22]">Preferred Plot Size</label>
                  <select className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm appearance-none">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-[#193A22]">Purchase Purpose</label>
                <select className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm appearance-none">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-[#193A22]">Preferred Site Visit Date</label>
                <input type="date" className="w-full px-4 py-3.5 rounded-xl border border-[#cbc4d2]/50 bg-white text-sm focus:outline-none focus:border-[#193A22] transition-colors shadow-sm text-[#494551]" />
              </div>
              ...
              <p className="text-[10px] text-[#494551] text-center mt-2 leading-relaxed">
                By submitting this form, you agree to receive calls, WhatsApp messages and project updates from JD Homes.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full bg-[#EEE3D3] py-16 md:py-24" id="location-advantage-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          {/* Left Column: Text */}
          <div className="flex flex-col text-left">
            <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Location Advantage</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#193A22] mb-6 font-headline leading-tight">
              Peaceful Countryside with<br/>Convenient Connectivity
            </h2>
            ...
            <div className="flex flex-col gap-5 mb-12">
              {[
                ...
                <div key={idx} className="flex items-start gap-3">
                  ...
                  <span className="text-sm md:text-base text-[#494551] font-light">{item}</span>
                </div>
              ))}
            </div>

            <button 
              onClick={() => window.open('https://maps.google.com/maps?ll=13.643381,77.543675&z=16&t=m&hl=en&gl=IN&mapclient=embed&cid=9940362746835670606', '_blank')}
      ...
      {/* Gallery Section */}
      <section className="w-full bg-[#FAF7F0] py-16 md:py-24" id="gallery-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Gallery</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="col-span-2 row-span-2 rounded-2xl overflow-hidden shadow-lg h-64 md:h-[424px]">
              <img src="/gallery/1.jpg" alt="Prashantha Vana Landscape" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            
            {/* Row 1 Right 1 */}
            <div className="col-span-1 rounded-2xl overflow-hidden shadow-lg h-32 md:h-[200px]">
              <img src="/gallery/2.jpg" alt="Fruit Picking" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>

            {/* Row 1 Right 2 */}
            <div className="col-span-1 rounded-2xl overflow-hidden shadow-lg h-32 md:h-[200px]">
              <img src="/gallery/3.jpg" alt="Plot Landscape" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>

            {/* Row 2 Right 1 */}
            <div className="col-span-2 md:col-span-1 rounded-2xl overflow-hidden shadow-lg h-32 md:h-[200px]">
              <img src="/gallery/4.jpg" alt="Entrance Gate" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            
            {/* Row 2 Right 2 - Empty to match screenshot layout */}
            <div className="col-span-1 hidden md:block"></div>

            {/* Row 3 */}
            <div className="col-span-2 rounded-2xl overflow-hidden shadow-lg h-40 md:h-[240px]">
              <img src="/gallery/5.jpg" alt="Courtyard House" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="col-span-1 rounded-2xl overflow-hidden shadow-lg h-40 md:h-[240px]">
              <img src="/pool.png" alt="Swimming Pool" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="col-span-1 rounded-2xl overflow-hidden shadow-lg h-40 md:h-[240px]">
              <img src="/cottages.png" alt="Cottages" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>

            {/* Row 4 */}
            <div className="col-span-2 rounded-2xl overflow-hidden shadow-lg h-48 md:h-[300px]">
              <img src="https://images.unsplash.com/photo-1523987355523-c7b5b0dd90a7?auto=format&fit=crop&w=1000&q=80" alt="Campfire" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#EEE3D3] py-16 md:py-24" id="faq-section">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <span className="text-[#D4B47C] font-bold tracking-[0.2em] uppercase text-xs mb-3 block">FAQ</span>
            <h2 className="text-3xl md:text-5xl font-bold text-[#193A22] font-headline">
          ...
          <div className="flex flex-col">
            {faqs.map((faq, idx) => (
              <div key={idx} className="border-t border-[#cbc4d2]/30 last:border-b">
                <button 
                ...
                <div 
                  className={`overflow-hidden transition-all duration-300 ease-in-out ${
                    activeFaq === idx ? 'max-h-48 opacity-100 pb-6' : 'max-h-0 opacity-0'
                  }`}
                >
