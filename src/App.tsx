...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F0] flex flex-col justify-between selection:bg-[#4f378a]/10 selection:text-[#4f378a]" id="app-root">
      ...
      <main className="flex-grow pt-20" id="main-content-wrapper">
        {renderActiveTab()}
      </main>
      ...
      <a
        href="https://wa.me/" // Note: The user will need to add their actual WhatsApp number here
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 lg:bottom-10 lg:right-10 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.2)] hover:shadow-[0_8px_30px_rgb(37,211,102,0.4)] hover:scale-110 transition-all duration-300 z-50 group"
